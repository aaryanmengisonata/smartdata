...
export default function FabricAudit({ setActivePage, setNavParams, featureState, setFeatureState }) {
   ...
   if (currentMode === 'intro') {
      return (
         <div className="w-full h-full flex flex-col p-8 lg:p-12 animate-in fade-in duration-700 bg-slate-50/30 overflow-y-auto">
            <div className="max-w-5xl mx-auto w-full">
               ...
               <div className="w-full flex items-center justify-between mb-8">
                  ...
                  <div className="hidden lg:flex items-center gap-2 px-4 py-2 bg-white rounded-full border border-slate-200 shadow-sm">
      ...
      <div className="h-full flex flex-col animate-in slide-in-from-right-8 duration-700 bg-slate-500/5 rounded-[2rem] overflow-hidden">
         ...
         <div className="px-8 py-6 border-b flex flex-wrap items-center gap-10 transition-colors border-slate-50">
            ...
            <button
               ...
               className={`group relative h-12 px-10 rounded-xl flex items-center justify-center gap-4 transition-all active:scale-95 shadow-xl ${isRunning
         ...
         <div className="flex-1 overflow-hidden relative group">
                              ...
                              {reportData.mismatchDetails.map((m, i) => (
                                 <tr key={i} className={`group hover:bg-slate-500/5 transition-colors border-b border-slate-500/5 last:border-0`}>
                                    ...
                                    <td className="px-6 py-4 text-right">
                                       <span className={`px-2 py-0.5 rounded-full text-[7px] font-black uppercase tracking-tighter ${m.risk === 'Critical' ? 'bg-rose-500/20 text-rose-500' :
            ...
            <button
               ...
               className={`absolute top-10 right-8 w-10 h-10 rounded-full flex items-center justify-center border transition-all shadow-2xl z-10 ${showLogs
